...
{ 0x82, (interrupt_handler_t) EXTIB_G_IRQHandler }, /* irq6 - External IT PORTB interrupt */
{ 0x82, (interrupt_handler_t) EXTID_H_IRQHandler }, /* irq7 - External IT PORTD interrupt */
...
{ 0x82, (interrupt_handler_t) LCD_AES_IRQHandler }, /* irq16 - LCD Driver interrupt */
{ 0x82, (interrupt_handler_t) SWITCH_CSS_BREAK_DAC_IRQHandler }, /* irq17 - Clock switch/CSS interrupt/TIM1 Break /DAC  interrupt */
{ 0x82, (interrupt_handler_t) ADC1_COMP_IRQHandler }, /* irq18 - ADC1 and Comparator interrupt */
//{ 0x82, (interrupt_handler_t) TIM2_UPD_IRQHandler }, /* irq19
{ 0x82, (interrupt_handler_t) TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQHandler }, /* irq19 - TIM2 Update/Overflow/Trigger/Break interrupt */
//{ 0x82, (interrupt_handler_t) TIM2_CH1_CCP_IRQHandler }, /* irq20
{ 0x82, (interrupt_handler_t) TIM2_CC_USART2_RX_IRQHandler }, /* irq20 - TIM2 Capture/Compare interrupt */
{ 0x82, (interrupt_handler_t) TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQHandler }, /* irq21 - TIM3 Update/Overflow/Trigger/Break interrupt */
{ 0x82, (interrupt_handler_t) TIM3_CC_USART3_RX_IRQHandler }, /* irq22 - TIM3 Capture/Compare interrupt */
{ 0x82, (interrupt_handler_t) TIM1_UPD_OVF_TRG_COM_IRQHandler }, /* irq23 - TIM1 Update/Overflow/Trigger interrupt */
...
{ 0x82, (interrupt_handler_t) USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQHandler }, /* irq27 - USART1 TX interrupt */
{ 0x82, (interrupt_handler_t) USART1_RX_TIM5_CC_IRQHandler }, /* irq28 - USART1 RX interrupt */
{ 0x82, (interrupt_handler_t) I2C1_SPI2_IRQHandler }, /* irq29 - I2C1 interrupt */
